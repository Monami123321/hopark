...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
				...
				.antMatchers("/user/login", "/user/regist", "/sports/searchByCondition", "/sports/getAll", "/sports/pick").permitAll() // http://localhost:8080/user/{login, regist} 요청은 무조건 허가함 (로그인 요청, 회원가입 요청, 운동 추천 받기, 운동 직접 고르기)
